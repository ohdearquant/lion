...
**Note**: If ephemeral, each CLI run re-initializes plugin manager. That’s okay
...
1. **Coherent plugin architecture**: Load, store in `HashMap`, invoke via
   orchestrator events.
