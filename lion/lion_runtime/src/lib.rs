...
impl Runtime {
    ...
    pub async fn grant_capability(&self, subject_id: String, object_id: String, rights: Vec<String>) -> Result<CapabilityId> {
        self.capabilities.grant_capability(subject_id, object_id, rights).await
    }
    ...
    pub async fn start_workflow(&self, workflow_id: WorkflowId, input: serde_json::Value) -> Result<()> {
