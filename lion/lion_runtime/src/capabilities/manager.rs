...
impl CapabilityManager {
    ...
    pub async fn grant_capability(
        ...
        info!("Granted capability {:?} to subject {} for object {}", cap_id, subject, object);
    ...
    pub async fn attenuate_capability(
        ...
        let parent = data.capabilities.get(&parent_id).ok_or_else(|| CapabilityError::NotFound(parent_id.clone()))?;
        ...
        info!("Created attenuated capability {:?} from {:?}", cap_id, parent_id);
    ...
    pub async fn check_permission(
        ...
        // Then check policy
        let policy_result = self.policy_evaluator.evaluate(subject, object, operation).await?;
