...
/// Core capabilities supported in the MVP
...
/// A factory trait for creating capability managers
pub trait CapabilityManagerFactory {
    /// Create a new capability manager
    fn create_capability_manager(&self) -> Arc<dyn CapabilityManager>;
}